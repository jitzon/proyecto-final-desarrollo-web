...
protected void configure(HttpSecurity http) throws Exception {
	...
	.antMatchers("/views/nombre/").hasAnyRole("USER")
	.antMatchers("/views/nombre/").hasAnyRole("ADMIN")
	.antMatchers("/views/descripcion/").hasAnyRole("USER")
	.antMatchers("/views/descripcion/").hasAnyRole("ADMIN")
	.antMatchers("/views/recetas/delete/**").hasAnyRole("ADMIN")
	.antMatchers("/views/recetas/edit/**").hasAnyRole("ADMIN")
	.antMatchers("/views/recetas/save").hasAnyRole("ADMIN")
	.antMatchers("/views/recetas/create").hasAnyRole("ADMIN")
	.antMatchers("/views/recetas/").hasAnyRole("USER")
